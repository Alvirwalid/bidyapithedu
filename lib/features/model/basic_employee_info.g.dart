...
part of 'basic_employee_info.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class BasicEmployeeInfoModelAdapter
    extends TypeAdapter<BasicEmployeeInfoModel> {
  @override
  final int typeId = 6;

  @override
  BasicEmployeeInfoModel read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return BasicEmployeeInfoModel(
  ...
  @override
  void write(BinaryWriter writer, BasicEmployeeInfoModel obj) {
    writer
      ..writeByte(4)
      ..writeByte(1)
      ..write(obj.status)
  ...
  bool operator ==(Object other) =>
      ...
      other is BasicEmployeeInfoModelAdapter &&
...
class DataAdapter extends TypeAdapter<Data> {
  ...
  Data read(BinaryReader reader) {
    ...
    return Data(
      ...
      permanentPostCode: fields[41] as int?,
