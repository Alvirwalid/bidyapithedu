class MaritalStatusDropdownListModel {
  bool? status;
  String? message;
  String? messageBn;
  List<Data>? data;

  MaritalStatusDropdownListModel({this.status, this.message, this.messageBn, this.data});

  MaritalStatusDropdownListModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
