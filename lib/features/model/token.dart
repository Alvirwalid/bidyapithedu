...
// part 'token.g.dart';
// @HiveType(typeId: 1)
// class Token {@HiveField(0)
// bool? status;@HiveField(1)
// String? message;@HiveField(2)
// String? messageBn;@HiveField(3)
// Data? data;
//
// Token({this.status, this.message, this.messageBn, this.data});
//
...
// }
// @HiveType(typeId: 3)
// class PasswordPolicy {@HiveField(0)
// var id;@HiveField(1)
// var name;@HiveField(2)
// var banglaName;@HiveField(3)
// bool? active;@HiveField(4)
// var minLength;@HiveField(5)
// bool? sequential;@HiveField(6)
// bool? specialChar;@HiveField(7)
// bool? alphanumeric;@HiveField(8)
// bool? upperLower;@HiveField(9)
// bool? matchUsername;@HiveField(10)
// bool? passwordRemember;@HiveField(11)
// var passwordAge;@HiveField(12)
// var devCode;
//
// PasswordPolicy(
//     {this.id,
