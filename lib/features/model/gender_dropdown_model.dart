class GenderDropdownListModel {
  bool? status;
  String? message;
  String? messageBn;
  List<Data>? data;

  GenderDropdownListModel({this.status, this.message, this.messageBn, this.data});

  GenderDropdownListModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
