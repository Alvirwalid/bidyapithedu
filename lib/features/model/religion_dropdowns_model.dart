class ReligionDropdownListModel {
  bool? status;
  String? message;
  String? messageBn;
  List<Data>? data;

  ReligionDropdownListModel({this.status, this.message, this.messageBn, this.data});

  ReligionDropdownListModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
